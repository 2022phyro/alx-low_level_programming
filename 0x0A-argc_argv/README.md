This is a directory that contains work pertaining to the argc and argv commands in c. it is how we pass arguments to our main functions outside the program. it contains the following files:
